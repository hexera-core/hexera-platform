...
def channel_for(job_id: str) -> str:
    return k(f"jobs:{job_id}:events")


def log_key_for(job_id: str) -> str:
    return k(f"jobs:{job_id}:eventlog")


def seq_key_for(job_id: str) -> str:
    return k(f"jobs:{job_id}:eventseq")


def opkey_set_for(job_id: str) -> str:
    return k(f"jobs:{job_id}:eventops")


def fence_key_for(job_id: str) -> str:
    return k(f"jobs:{job_id}:eventfence")
