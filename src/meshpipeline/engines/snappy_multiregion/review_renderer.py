# Responsibility: Render the views a reviewer needs to judge a multi-region snappyHexMesh mesh.
...
class SnappyMultiregionReviewRenderer:

    def required_artifacts(self):
        from meshpipeline.engines.snappy_multiregion._shared import _RENDER_ARTIFACTS
    ...
    def open(self, context: RenderContext,
        ...
        from meshpipeline.engines.snappy_multiregion._shared import _INSPECTION_TARGETS
        ...
        return BackendRenderSession(
            ...
            opening_purpose="the full multi-region boundary as delivered, before the reviewer moves anything",
        )


RENDERER = SnappyMultiregionReviewRenderer()
