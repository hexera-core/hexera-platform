# Responsibility: Turn a multi-region polyMesh boundary into a viewer payload, or nothing when no mesh was written.
...
def polymesh_viewer(workspace, *, roles: dict, units: str,
    ...
    if not (pm / "boundary").exists():
        return None
    from meshpipeline.engines.snappy_multiregion.polymesh_surface import boundary_surface
