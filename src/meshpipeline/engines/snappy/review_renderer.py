# Responsibility: Render the views a reviewer needs to judge a snappyHexMesh mesh.
...
class SnappyReviewRenderer:

    def required_artifacts(self):
        from meshpipeline.engines.snappy._shared import _RENDER_ARTIFACTS
    ...
    def open(self, context: RenderContext,
        ...
        from meshpipeline.engines.snappy._shared import _INSPECTION_TARGETS
        ...
        return BackendRenderSession(
            ...
            opening_purpose="the mesh as delivered, before the reviewer moves anything",
        )


RENDERER = SnappyReviewRenderer()
