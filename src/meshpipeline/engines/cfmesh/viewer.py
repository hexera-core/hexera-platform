# Responsibility: Turn cfMesh's polyMesh boundary into a viewer payload, or nothing when no mesh was written.
...
def polymesh_viewer(workspace, *, roles: dict, units: str,
    ...
    if not (pm / "boundary").exists():
        return None
    from meshpipeline.engines.cfmesh.polymesh_surface import boundary_surface
