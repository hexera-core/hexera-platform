                ...
                "properties": {
                    ...
                    "port_details_note": {
                        ...
                        "description": (
                            ...
                            "circular bore diameter; for an ANNULAR opening add "
                            "'inner_diameter_mm', the centre body's diameter, and state both "
                            "as given - never compute the ring's area yourself), OR 'area_mm2', "
